...
function makeGrid() {
//clear matrix
  vGrid.innerHTML = ""; //(attribution: https://knowledge.udacity.com/questions/561177)
//loop that creates the rows
  ...
  while (i < vHeight.value) {
    ...
    while (j < vWidth.value) {
      ...
      cubicles.addEventListener("click", function(){ //(attribution: https://knowledge.udacity.com/questions/297130)
...
vSizePicker.addEventListener('submit', function(GenerateWhenSubmit) {
  ...
  GenerateWhenSubmit.preventDefault(); //(attribution: https://developer.mozilla.org/en-US/docs/Web/API/Event/preventDefault)
